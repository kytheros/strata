---
name: recall
description: Search Strata memory for past conversations, decisions, solutions, and knowledge. Use when the user asks what was decided, how something was fixed, or what happened in past sessions.
---
