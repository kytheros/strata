...
describe("VectorSearch dimension guard", () => {
  it("skips a stored float32 vector whose length != query length instead of returning a garbage score", () => {
  ...
  it("skips a Gemini quantized (tq4) blob on the quantized fast-path when query is 768-dim", () => {
